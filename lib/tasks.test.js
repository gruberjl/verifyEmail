const {isEmail, getDomain, getMx, convert, getDomains, sortByDomain, groupByDomain} = require('./tasks.js')
...
describe('emailExists', () => {
  test('should resolve', () => emailExists('gitbit-org.mail.protection.outlook.com', 'john.gruber@gitbit.org').then((results) => {
    expect(results).toContainEqual(123)
  }))
})
